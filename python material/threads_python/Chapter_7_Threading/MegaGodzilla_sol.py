...
class MegaGodzilla(threading.Thread):
    ...
    def attacked(self, soldier):
        ...
        if not self.alive:
            ...
            print(
                "Mega-Godzilla has been attacked! The soldier has"
                "caused damage" + str(soldier.attack) + ". HP Godzilla " + str(self.hp)
            )
...
class Soldier(threading.Thread):
    ...
    def attacked(self, attack):
        self.hp -= attack
        print(f"The soldier{str(self.ID)} has been damaged!!  HP {str(self.hp)}")
        if not self.alive:
            print(f"The soldier{str(self.ID)} has died :( !!!")
